...
const AGENT_NAME = 'Nadi'
const ASSISTANT_ID = 'cc54f949-28ef-42bf-82d8-f1ceedc5eec4'

export const metadata: Metadata = {
  title: `${AGENT_NAME} — Fort Bazaar AI Voice Demo | Mytosis`,
  description: `Live demo of ${AGENT_NAME}, the AI voice agent built for Fort Bazaar by Mytosis. She answers calls, checks availability, and books direct — 24/7.`,
  robots: 'noindex, nofollow',
}

export default function FortBazaarDemoPage() {
  return (
        ...
        <div className="relative z-10" style={{ padding: '96px 48px 0' }}>
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="mt-6 text-xl md:text-2xl text-neutral-400 italic max-w-lg mx-auto">
              Fort Bazaar&apos;s AI voice agent. She answers every call, checks live availability, and
            ...
            <p className="text-neutral-600 text-xs mt-6">
              ...
              Fort Bazaar reservation system.
            </p>
          </div>
        </div>
