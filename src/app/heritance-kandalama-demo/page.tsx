...
const AGENT_NAME = 'Devika'
const ASSISTANT_ID = 'df96e99a-b9fb-42b6-bee0-e7bf9183d8d6'

export const metadata: Metadata = {
  title: `${AGENT_NAME} — Heritance Kandalama AI Voice Demo | Mytosis`,
  description: `Live demo of ${AGENT_NAME}, the AI voice agent built for Heritance Kandalama by Mytosis. She answers calls, checks availability, and books direct — 24/7.`,
  robots: 'noindex, nofollow',
}

export default function HeritanceKandalamaDemoPage() {
  return (
        ...
        <div className="relative z-10" style={{ padding: '96px 48px 0' }}>
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="mt-6 text-xl md:text-2xl text-neutral-400 italic max-w-lg mx-auto">
              Heritance Kandalama&apos;s AI voice agent. She answers every call, checks live
              availability, and books direct — 24 hours a day.
            </p>
            <p className="text-neutral-600 text-xs mt-6">
              This is a live demo. {AGENT_NAME} is connected to a test environment — not Heritance
              Kandalama&apos;s live reservation system.
            </p>
          </div>
        </div>
