...
const AGENT_NAME = 'Malee'
const ASSISTANT_ID = 'd1dcc461-061a-4cf5-a090-9d4896589a5d'

export const metadata: Metadata = {
  title: `${AGENT_NAME} — Malabar Hill AI Voice Demo | Mytosis`,
  description: `Live demo of ${AGENT_NAME}, the AI voice agent built for Malabar Hill by Mytosis. She answers calls, checks availability, and books direct — 24/7.`,
  robots: 'noindex, nofollow',
}

export default function MalabarHillDemoPage() {
  return (
        ...
        <div className="relative z-10" style={{ padding: '96px 48px 0' }}>
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="mt-6 text-xl md:text-2xl text-neutral-400 italic max-w-lg mx-auto">
              Malabar Hill&apos;s AI voice agent. She answers every call, checks live availability,
              and books direct — 24 hours a day.
            </p>
            <p className="text-neutral-600 text-xs mt-6">
              This is a live demo. {AGENT_NAME} is connected to a test environment — not Malabar
              Hill&apos;s live reservation system.
            </p>
          </div>
        </div>
