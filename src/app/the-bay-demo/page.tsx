...
const ASSISTANT_ID = 'bd2f57f6-6ad1-4487-9aaf-dc11c3a22414'

export const metadata: Metadata = {
  title: `${AGENT_NAME} — The Bay AI Voice Demo | Mytosis`,
  description: `Live demo of ${AGENT_NAME}, the AI voice agent built for The Bay by Uga Experiences by Mytosis. She answers calls, checks availability, and books direct — 24/7.`,
  robots: 'noindex, nofollow',
}

export default function TheBayDemoPage() {
  return (
        ...
        <div className="relative z-10" style={{ padding: '96px 48px 0' }}>
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-neutral-500 text-xs tracking-[0.2em] uppercase mb-4">
              Live Demo &nbsp;·&nbsp; The Bay by Uga Experiences
            </p>
            ...
            <p className="mt-6 text-xl md:text-2xl text-neutral-400 italic max-w-lg mx-auto">
              The Bay&apos;s AI voice agent. She answers every call, checks live availability, and
              books direct — 24 hours a day.
            </p>
            <p className="text-neutral-600 text-xs mt-6">
              This is a live demo. {AGENT_NAME} is connected to a test environment — not The Bay&apos;s
