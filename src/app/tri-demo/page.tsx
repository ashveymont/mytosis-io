...
const AGENT_NAME = 'Senara'
const ASSISTANT_ID = 'a816379d-1599-4da1-8350-81dc99bc841d'

export const metadata: Metadata = {
  title: `${AGENT_NAME} — Tri AI Voice Demo | Mytosis`,
  description: `Live demo of ${AGENT_NAME}, the AI voice agent built for Tri by Mytosis. She answers calls, checks availability, and books direct — 24/7.`,
  robots: 'noindex, nofollow',
}

export default function TriDemoPage() {
  return (
        ...
        <div className="relative z-10" style={{ padding: '96px 48px 0' }}>
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="mt-6 text-xl md:text-2xl text-neutral-400 italic max-w-lg mx-auto">
              Tri&apos;s AI voice agent. She answers every call, checks live availability, and
              books direct — 24 hours a day.
            </p>
            <p className="text-neutral-600 text-xs mt-6">
              This is a live demo. {AGENT_NAME} is connected to a test environment — not Tri&apos;s
